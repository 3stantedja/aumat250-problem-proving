...
\begin{document}
    \begin{problem}
        ...
        You probably figured out in class that the statement \[(\exists f)(\forall g) P(f,g)\] is false. So its negation must be true. Write a careful, thoroughly-convincing argument that this negation is true.
